...
async def test_endpoints():
    ...
    async with aiohttp.ClientSession() as session:
        for ep in endpoints:
            url = f"{BASE_URL}/cafe/{CAFE_ID}/{ep}"
            print(f"\n--- Testing {ep} ---")
            try:
